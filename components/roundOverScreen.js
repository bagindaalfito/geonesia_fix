...
export default function RoundOverScreen({
  ...
  useEffect(() => {
    let newStars = [];
    if (animatedPoints >= 48000) {
      newStars = [
        "/platinum_star.png",
        "/platinum_star.png",
        "/platinum_star.png",
      ];
    } else if (animatedPoints >= 45000) {
      newStars = ["/platinum_star.png", "/platinum_star.png", "gold"];
    } else if (animatedPoints >= 40000) {
      newStars = ["/platinum_star.png", "gold", "gold"];
    } else if (animatedPoints >= 35000) {
      newStars = ["gold", "gold", "gold"];
    } else if (animatedPoints >= 30000) {
      newStars = ["gold", "gold", "#CD7F32"];
    } else if (animatedPoints >= 25000) {
