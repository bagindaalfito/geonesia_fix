...
export default function GameUI({ miniMapShown, setMiniMapShown, singlePlayerRound,mulailagi, setSinglePlayerRound, showDiscordModal, setShowDiscordModal, inCrazyGames, showPanoOnResult, setShowPanoOnResult, countryGuesserCorrect, setCountryGuesserCorrect, otherOptions, onboarding, setOnboarding, countryGuesser, options, timeOffset, ws, multiplayerState, backBtnPressed, setMultiplayerState, countryStreak, setCountryStreak, loading, setLoading, session, hintgambar, gameOptionsModalShown, setGameOptionsModalShown, latLong, streetViewShown, setStreetViewShown, loadLocation, gameOptions, setGameOptions, showAnswer, setShowAnswer, pinPoint, setPinPoint, hintShown, setHintShown, xpEarned, setXpEarned, showCountryButtons, setShowCountryButtons }) {
  const { t: text } = useTranslation("common");
  const [showStreakAdBanner, setShowStreakAdBanner] = useState(false);

  function setgambarhint(lokasi) {
    const hintgambar1 = document.getElementById('hintgambar1');
    const hintgambar2 = document.getElementById('hintgambar2');
    const hintgambar3 = document.getElementById('hintgambar3');
    if(screen=="onboarding")
    {
      
    // console.log(lokasi.namatempat);
    hintgambar1.src = lokasi.gambar1; 
    hintgambar2.src = lokasi.gambar2; 
    hintgambar3.src = lokasi.gambar3;    
    }
      else
      {
        // console.log(lokasi);
  ...
  function showHint() {
    // console.log(latLong);
    setgambarhint(latLong);
    document.getElementById('hintgambar1').style.display = 'block';
    document.getElementById('hintgambar2').style.display = 'block';
    document.getElementById('hintgambar3').style.display = 'block';
    setHintShown(true)
    // Get the modal
var modal = document.getElementById("myModal");

// Get all images with the class "myImg"
var imgs = document.querySelectorAll(".w3-col");
...
span.onclick = function() {
  ...
  function guess() {    
    document.getElementById('hintgambar1').style.display = 'none';
    document.getElementById('hintgambar2').style.display = 'none';
    document.getElementById('hintgambar3').style.display = 'none';
    setShowAnswer(true)
...
<div className="w3-row" style={{display: 'flex'}}>
  <img className="w3-col" id="hintgambar1" src= "" width="500" height="500" style={{display: 'None', width: '250px', height: '175px'}} />
  <img className="w3-col" id="hintgambar2" src= "" width="500" height="500" style={{display: 'None', width: '250px', height: '175px'}} />
  <img className="w3-col" id="hintgambar3" src= "" width="500" height="500" style={{display: 'None', width: '250px', height: '175px'}} />
</div>
